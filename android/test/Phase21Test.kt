...
fun main() {
    ...
    run {
        ...
        val s1 = kotlinx.coroutines.runBlocking { Pipeline.buildSnapshot(domains, "IPv4", log = {}) }
        val s2 = kotlinx.coroutines.runBlocking { Pipeline.buildSnapshot(domains, "IPv4", log = {}) }
